...
namespace NProxy.Core.Test
{
    ...
    public sealed class ProxyFactoryTestFixture
    {
        ...
        public void CreateProxyFromInterfaceWithNonInterceptedEventTest()
        {
            ...
            // Act
            var proxy = _proxyFactory.CreateProxy<INonIntercepted>(Type.EmptyTypes, interceptor);
        ...
        public void CreateProxyFromAbstractClassWithNonInterceptedEventTest()
        {
            ...
            // Act
            var proxy = _proxyFactory.CreateProxy<NonInterceptedBase>(Type.EmptyTypes, interceptor);
        ...
        public void CreateProxyFromClassWithNonInterceptedEventTest()
        {
            ...
            // Act
            var proxy = _proxyFactory.CreateProxy<NonIntercepted>(Type.EmptyTypes, interceptor);

            proxy.Event += () => { };

            // Assert
            Assert.That(interceptor.InvocationCount, Is.EqualTo(0));
        }
